...
function cover_init(e) {
    ...
    if (n) {
        ...
        (window.t_cover__isMobile || "ontouchend" in document) && v && !o && (n.style.backgroundImage = 'url("' + c["cover-bg"] + '")'),
        setTimeout((function() {
...
function t_cover__setCoverVideoParams(e, t, o, r) {
    var n = "";
    if (t["video-url-youtube"] && (n = "youtube"), (t["video-url-vimeo"] || t["video-url-rutube"] || t["video-url-kinescope"] || t["video-url-vkvideo"]) && (n = "iframe"), (!window.t_cover__isMobile && !("ontouchend" in document) || -1 === ["on", null].indexOf(t["use-image-for-mobile-cover"])) && o)
        switch (t_cover__setStylesForCoverVideo(e, "youtube" === n ? "youtube" : ""), n) {
        case "youtube":
...
function t_cover__processHTML5Video(e, t, o) {
    ...
    var r,
        n = !!(-1 !== t["cover-height"].indexOf("vh")) && parseInt(t["cover-height"], 10) > 100,
        i,
        c = !!(-1 !== t["cover-height"].indexOf("px")) && parseInt(t["cover-height"], 10) > window.innerHeight,
        a = !1;
...
function t_cover__setWordWrapOnInit() {
    var e = Array.from(document.querySelectorAll(".t-cover__wrapper")),
...
function t_cover__setRecalculatedHeight(e, t) {
    ...
    var i = t_cover__getHeightFromAttr(r),
        ...
        a = t_cover__getRecordType(e),
        d = "734" === a,
        _ = "942" === a,
        u = window.innerWidth <= 568 ? 40 : 120,
        v = window.innerWidth <= 568 ? 50 : 100;
    (d || _) && (u = 0, v = 0),
    (t += u) > 1e3 && (t += v);
    var l = t > i ? t : i,
        s = 0,
        g = [".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper"];
    (d || e.querySelector(".t734")) && g.push(".t-slds__items-wrapper"),
    g.forEach((function(t) {
        var o;
        Array.prototype.slice.call(e.querySelectorAll(t)).forEach((function(e) {
            c && e && e.classList.contains("t-cover__carrier") && l < document.documentElement.clientHeight ? (s = .2 * document.documentElement.clientHeight, e.style.height = l + s + "px") : e && (e.style.height = l + "px")
        }))
    })),
    o.setAttribute("data-content-cover-updated-height", l + s + "px");
    var f = document.createEvent("Event");
    f.initEvent("coverHeightUpdated", !0, !0),
    o.dispatchEvent(f)
}
function t_cover__getRecordType(e) {
    var t;
    return e && (e.getAttribute("data-record-type") || (null == (t = e.closest(".record")) ? void 0 : t.getAttribute("data-record-type"))) || ""
}
...
function t_cover__scrollToNextSection(e) {
    var t,
        o = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight, document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight) - document.documentElement.clientHeight;
    ...
    var r = window.pageYOffset,
        ...
        c = setInterval((function() {
            ...
            (e - r < 0 && window.pageYOffset <= e || e - r > 0 && window.pageYOffset >= e) && (clearInterval(c), document.body.removeAttribute("data-scrollable"))
        }), 10)
}
...
t_onReady((function() {
    t_onFuncLoad("t_cover__initCovers", (function() {
        t_cover__initCovers(),
        "complete" === document.readyState ? t_cover__setWordWrapOnInit() : window.addEventListener("load", t_cover__setWordWrapOnInit)
    }))
}));
